        ...
        if self.inital == 'random':
            ...
            for n in range(200):
                ...
                for i in range(self.sweeps):
                    ...
                    if i >5:
                        if living_cells[i] == living_cells[i-1] and living_cells[i] == living_cells[i-2] and living_cells[i] == living_cells[i-3]:
                            t_stable.append(i-3)
                            break
...
if __name__ == "__main__":
    ...
    if len(sys.argv) != 5:
        ...
        print("Usage: " + sys.argv[0] + "lattice Size, Number of sweeps, inital conditions, Data/Animate")
        quit()
